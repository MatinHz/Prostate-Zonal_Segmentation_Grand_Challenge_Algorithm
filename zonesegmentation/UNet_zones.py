...
def predict(img_arr, modelName):
    ...
    prediction = model.predict([img_arr[1]], batch_size=2, verbose=1)
...
if __name__ == '__main__':
    ...
    print('RUNNIG SEGMENTATION MODEL...')
    ...
    roi_tra = sitk.ReadImage(os.path.join(inputDir, 'roi_tra.nii.gz'))
    ...
    sitk.WriteImage(pred_img, os.path.join(inputDir, 'predicted_roi.nii.gz'))
    print('FINISHED!')
